...
export function Contact() {
  return (
    <section id="contact" className="py-20 px-6 border-t border-border/30">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold mb-2">交流与联系</h2>
          <p className="text-sm text-muted-foreground">加入微信群交流使用体验、功能建议和创作工作流</p>
        </div>
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3 px-6 py-4 rounded-xl bg-muted border border-border/50">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium">微信群交流</span>
            </div>
            <img
              src={`${import.meta.env.BASE_URL}wechat-group-qr.jpg`}
              alt="灵机剪影微信群二维码"
              className="w-36 h-52 rounded-lg object-cover"
            />
          </div>
        </motion.div>
      </div>
